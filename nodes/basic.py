...
지원되지 않는 복잡한 기술적 문제나 업무 처리에 대해서는 '나의내일'의 핵심 서비스(자소서 작성, 일자리 찾기, 자소서 검증)를 다시 안내하며 유도하세요.
"""
    ...
    try:
        ...
        ai_response = "무슨 말씀인지 잘 이해하지 못했어요. 자소서 작성, 일자리 검색, 자소서 검증 중 어떤 걸 도와드릴까요?"
